========================================================================
    APLICACIÓN DE CONSOLA: PruebaMotorOpenGL4 Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PruebaMotorOpenGL4.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación PruebaMotorOpenGL4.


PruebaMotorOpenGL4.vcxproj
...
PruebaMotorOpenGL4.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado PruebaMotorOpenGL4.pch y un archivo de tipos precompilados llamado StdAfx.obj.
